...
assert(max(abs(amplitude))<=maxGrad,'makeTrapezoid:invalidAmplitude','Amplitude violation'); %included max on this line
...
grad.area = amplitude.*(flatTime + riseTime/2 + fallTime/2); %Changed this * to .*
