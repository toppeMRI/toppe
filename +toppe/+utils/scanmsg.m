...
fprintf('\nRename the .entry file as needed and copy to /usr/g/research/pulseq/ on scanner host.\n');
fprintf('  (For example, name it ''toppe10.entry'' and set opuser1 (user CV1) = 10 when prescribing the scan.)\n');
fprintf('Check that the scan file path on line 1 in the .entry file is correct.\n');
